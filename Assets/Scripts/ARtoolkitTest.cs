...
public class ARtoolkitTest : MonoBehaviour
{
    [SerializeField]
    ...
    public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
    {
        ...
        //var newObject = Instantiate(m_ObjectPrefabs);
        ...
        //newObject.transform.rotation = m_CameraToFace.transform.rotation;
